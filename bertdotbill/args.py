...
def parse_args(**kwargs):
  ...
  parser.add_argument('--dashboard-config-file', '-fd', help="Path to sidebar configuration file")
  parser.add_argument('--sidebar-config-file', '-fs', help="Path to sidebar configuration file")
